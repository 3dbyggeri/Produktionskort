...
<b>Du skal dog være opmærksom på følgende:</b>

Ifm. POST og PUT requests bør den XML du sender til API'et ikke indeholde
<tt><created-at></tt> og <tt><updated-at></tt>. Disse timestamps vedligeholdes
af Produktionskort.

Ifm. POST requests bør du undlade at angive <tt><id></tt>, da resoursens ID
automatisk vil blive tildelt af Produktionskort.
...
Hvis din forespørgsel ikke giver noget resultat vil du modtage dette XML
response:
